...
const NAV_LINKS = [
  ...
  { label: "Requirements", path: "/hr-account-requirements" },
];
                    ...
                    >
                      <div
                        className={`w-10 h-10 min-w-[2.5rem] rounded-xl flex items-center justify-center text-lg ${
                          notif.unread ? "bg-teal-100" : "bg-slate-100"
                        }`}
                      >
                        {notif.icon}
                      </div>
        ...
        <ul className="flex items-center gap-6 list-none m-0 p-0 ml-auto h-full">
          ...
          >
            <Link
              ...
              className="flex items-center gap-1 text-lg no-underline transition-colors pb-1"
              style={{
                color: pathname === "/my-profile" || showProfile ? "white" : "rgb(148,163,184)",
                fontWeight: pathname === "/my-profile" || showProfile ? 700 : 400,
                borderBottom: pathname === "/my-profile" || showProfile
                  ? "2px solid #38bdf8"
                  : "2px solid transparent",
              }}
            >
            ...
            {showProfile && (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-[#0B2447] hover:text-teal-600 text-sm font-semibold w-full bg-transparent border-none cursor-pointer p-0 mb-3"
                >
                  My Profile
                </button>
