      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-1">
            Select a plan to activate your company account
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
          {plans.map((plan) => (
            ...
            >
              ...
              <button
                onClick={() => navigate(plan.planType === "free" ? "/login-company" : "/receipt")}
              ...
              >
                {plan.buttonLabel}
                <span className="w-6 h-6 rounded-full bg-[#1a2e6b] text-white flex items-center justify-center text-xs">
                  →
                </span>
              </button>
            </div>
